        ...
        <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
            <div className='flex flex-col md:flex-row'>
                   ...
                   {selectedProduct.images.map((image, index)=>(
                      <img 
                        ...
                        className={`w-20 h-20 object-cover rounded-lg cursor-pointer border
                            ${mainImage === getImageUrl(image.url)? "border-black": "border-gray-300"}`}
                      />
                   ))}
                </div>
                ...
                <div className="md:w-1/2">
                    <div className="mb-4">
                        <img 
                          src={mainImage || getImageUrl(selectedProduct?.images?.[0]?.url)}
                          alt="Main Product"
                        />
                    </div>
                </div>
                ...
                <div className="md:w-1/2 md:ml-10">
                    ...
                    <button 
                     ...
                     className={`bg-black text-white py-2 px-6 rounded w-full mb-4 cursor-pointer
                       ${isButtonDisabled ? "cursor-not-allowed backdrop-blur-md" :"hover:bg-gray-900"}`}>
