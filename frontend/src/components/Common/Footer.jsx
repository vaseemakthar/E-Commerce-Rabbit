  ...
  return (
    <footer className="border-t py-12">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
          <div>
            ...
            <p className="text-gray-500 mb-4">
                Be the frst to hear about new products, exclusive events, and
                online offers.
            </p>
          ...
          <div>
            <h3 className="font-semibold text-lg text-gray-800 mb-4">Shop</h3>
          ...
          <div>
            <h3 className="font-semibold text-lg text-gray-800 mb-4">Support</h3>
            <ul className="space-y-2 text-gray-600">
               <li>
                 <Link to="#" className="hover:text-gray-500 transition-colors">
                    Contact Us
        ...
        <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
           <p className="text-gray-500 text-sm tracking-tighter text-center">&copy; 2025, ComplieTab, All Rights Reserved.</p>
        </div>
    </footer>
  )
}
